    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-[42%] bg-navy-950 flex-col justify-between p-12 relative overflow-hidden">
        ...
        <div className="relative z-10 flex items-center gap-3">
          ...
          <span className="text-white font-bold text-sm tracking-wide">iMile — Atendimento</span>
        </div>

        <div className="relative z-10">
          <div className="w-10 h-1 bg-imile-500 rounded-full mb-6" />
          <h2 className="text-3xl font-bold text-white leading-tight mb-4">
            Central de<br />Atendimento<br />WhatsApp
          </h2>
          <p className="text-white/50 text-sm leading-relaxed max-w-xs">
            Visualize e responda conversas de confirmação de entrega em tempo real.
          </p>
          <div className="mt-10 space-y-3">
            {['Histórico completo de conversas', 'Respostas manuais por contato', 'Atualização de status em tempo real', 'Filtro por campanha e status'].map(item => (
      ...
      <div className="flex-1 flex items-center justify-center bg-[#f8fafc] px-6 py-12">
        <div className="w-full max-w-[360px]">
          ...
          <div className="mb-8 lg:hidden flex items-center gap-2">
            ...
            <span className="text-slate-800 font-bold text-sm">iMile — Atendimento WhatsApp</span>
          </div>

          <form onSubmit={handle}>
            <p className="text-xs font-semibold uppercase tracking-widest text-imile-500 mb-1">Atendimento</p>
            ...
            <div className="space-y-4">
              <div>
                ...
                <input type="email" value={email} onChange={e => setEmail(e.target.value)}
                  ...
                  className="mt-1.5 w-full px-4 py-2.5 rounded-xl border border-slate-200 bg-white text-sm text-slate-900 placeholder:text-slate-300 focus:outline-none focus:ring-2 focus:ring-imile-500/20 focus:border-imile-400 transition-all" />
              </div>
              <div>
                ...
                <div className="relative">
                  <input type={showPw ? 'text' : 'password'} value={senha} onChange={e => setSenha(e.target.value)}
                    ...
                    className="mt-1.5 w-full px-4 py-2.5 pr-11 rounded-xl border border-slate-200 bg-white text-sm text-slate-900 placeholder:text-slate-300 focus:outline-none focus:ring-2 focus:ring-imile-500/20 focus:border-imile-400 transition-all" />
            ...
            <button type="submit" disabled={loading}
              className="mt-6 w-full flex items-center justify-center gap-2 py-2.5 rounded-xl bg-imile-500 hover:bg-imile-600 text-white font-semibold text-sm transition-all disabled:opacity-60 shadow-[0_4px_14px_0_rgb(233_113_50_/_0.30)]">
              {loading
